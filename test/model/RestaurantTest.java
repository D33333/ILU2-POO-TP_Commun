...
class RestaurantTest {
	...
	void testDonnerPossibilites() {
		...
		assertArrayEquals(expected, possibilites,"Les tables numeros 2 et 3 devraient pouvoir étre choisi");

		int[] expected2 = { 0, 2, 3, 0, 0, 0, 7};
		restaurant.ajouterTable(3);
		possibilites = restaurant.donnerPossibilites(formulaire);
		assertArrayEquals(expected2, possibilites,"Les tables numeros 2, 3 et 7 devraient pouvoir étre choisi");
	}
